          ...
          <div className="absolute inset-x-0 bottom-0 z-[500] flex h-7 items-center overflow-x-auto border-t border-slate-200 bg-white/95 px-2 text-[7.5px] font-medium text-slate-700 sm:text-[9px] md:h-9 md:px-4 md:text-[11px]">
            ...
            {showElevationChart && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md border border-slate-200 bg-white px-2 py-0.5 text-[9px] font-semibold text-slate-600 hover:bg-slate-50 sm:px-2.5 sm:text-[10px]"
              >
                Close
              </button>
            )}
